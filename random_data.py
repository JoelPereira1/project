...
from shop.models.user import Role, User, UserAddress, UserRole
from shop.models.checkout import ShippingMethod
...
from shop.models.order import Order, OrderLine, OrderPayment
...
from shop.models.public import MenuItem, Page
...
PLANT_CATEGORY = {"name": "Plants", "image_name": "plant-cat.jpg"}
ALGEA_CATEGORY = {"name": "Algea", "image_name": "algea.jpg"}
FUNGI_CATEGORY = {"name": "Fungi", "image_name": "fungi.jpg"}

DEFAULT_SCHEMA = {
  "Wedding": {
    "category": {
      "name": "Plants",
      "image_name": "plants-list.jpg",
      "parent": PLANT_CATEGORY
    },
    "product_attributes": {
        "Color": ["Red", "White"]
    },
    "variant_titles": ["Buquet", "Flower"],
    "images_dir": "plants/",
  ...
  "Funeral": {
    "category": {
      "name": "Crowns",
      "image_name": "crown-list.jpg",
      "parent": PLANT_CATEGORY
      },
    "product_attributes": {"Brand": ["MyBrand"]},
    "variant_titles": [],
    "images_dir": "plants/",
    "is_shipping_required": True
  },
  "Mushrooms": {
    "category": {
        "name": "Mush",
        "image_name": "fungi-list.jpg",
        "parent": FUNGI_CATEGORY,
    },
    "product_attributes": {
      "Products": ["Powder", "Plant"]
    },
  ...
  "Medicine": {
      "category": {
        "name": "Algea",
        "image_name": "algea-list.jpg",
        "parent": ALGEA_CATEGORY,
      },
      "product_attributes": {"Flavor": ["Sour", "Sweet"], "Brand": ["MyBrand"]},
...
COLLECTIONS_SCHEMA = [
  {"name": "Wedding collection", "image_name": "weffing.jpg"}
]
